...
export const createGoalService = async (input, userId) => {
...
export const getGoalService = async (goalId, userId) => {
...
export const updateGoalService = async (input, userId) => {
...
export const completeGoalService = async (input, userId) => {
    const { goalId } = input;
    return prisma.$transaction(async (tx) => {
        const goal = await tx.goal.findUnique({
            where: { id: goalId },
...
export const deleteGoalService = async (input, userId) => {
    const { goalId } = input;
    return prisma.$transaction(async (tx) => {
        const goal = await tx.goal.findUnique({
            where: { id: goalId },
