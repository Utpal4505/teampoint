...
const validateEntityAndProject = async (tx, entityType, entityId, projectId) => {
    switch (entityType) {
        case 'TASK':
...
export const createDocumentLinkService = async (input, userId) => {
    ...
    return prisma.$transaction(async (tx) => {
        ...
        const entity = await validateEntityAndProject(tx, entityType, entityId, document.projectId);
...
export const unlinkDocumentService = async (linkId, userId) => {
    return prisma.$transaction(async (tx) => {
...
//# sourceMappingURL=documentLinks.service.js.map