...
import { createMessageSchema, discussionIdParamSchema, messageIdParamSchema, projectIdParamSchema, updateMessageSchema, } from './message.schema.js';
import { createMessageService, deleteMessageService, listMessagesService, updateMessageService, } from './message.service.js';
...
export const deleteMessageController = asyncHandler(async (req, res) => {
    ...
    const message = await deleteMessageService(projectId, discussionId, messageId, req.user.id);
    return res
        .status(200)
...
export const updateMessageController = asyncHandler(async (req, res) => {
    ...
    const message = await updateMessageService(projectId, discussionId, messageId, body.content, req.user.id);
    return res
        .status(200)
