...
const assertDiscussionPermission = async (tx, projectId, userId, permission) => {
...
const assertDiscussionOwnerOrPermission = async (tx, projectId, discussionCreatorId, userId, permission) => {
...
const assertDiscussionContext = async (tx, input) => {
...
export const createDiscussionService = async (input, userId) => {
...
export const updateDiscussionService = async (input, userId) => {
    return prisma.$transaction(async (tx) => {
        ...
        if (discussion.createdBy !== userId) {
            await assertDiscussionPermission(tx, input.projectId, userId, 'canEditAnyDiscussion');
        }
...
export const closeDiscussionService = async (projectId, discussionId, userId) => {
    return prisma.$transaction(async (tx) => {
        const discussion = await tx.discussion.findFirst({
            where: {
                id: discussionId,
        ...
        await assertDiscussionOwnerOrPermission(tx, projectId, discussion.createdBy, userId, 'canCloseDiscussions');
...
export const reopenDiscussionService = async (projectId, discussionId, userId) => {
    return prisma.$transaction(async (tx) => {
        const discussion = await tx.discussion.findFirst({
            where: {
                id: discussionId,
        ...
        await assertDiscussionOwnerOrPermission(tx, projectId, discussion.createdBy, userId, 'canReopenDiscussions');
        const updated = await tx.discussion.update({
            where: { id: discussionId },
            data: {
                status: DiscussionStatus.OPEN,
...
export const deleteDiscussionService = async (projectId, discussionId, userId) => {
    return prisma.$transaction(async (tx) => {
        const discussion = await tx.discussion.findFirst({
            where: {
                id: discussionId,
        ...
        ensureExists(discussion, 'Discussion');
        await assertDiscussionOwnerOrPermission(tx, projectId, discussion.createdBy, userId, 'canEditAnyDiscussion');
        const workspaceId = await getWorkspaceIdFromProject(projectId, userId, tx);
