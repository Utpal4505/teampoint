...
export const deleteUserService = async ({ userId, }) => {
    return prisma.$transaction(async (prisma) => {
        const updatedUser = handlePrismaNotFound(prisma.user.update({
            where: {
                id: userId,
                status: 'ACTIVE',
            },
...
export const updateUserService = async (input) => {
    ...
    return handlePrismaNotFound(prisma.user.update({
        where: {
            id: userId,
            status: 'ACTIVE',
        },
...
export const avatarCompleteService = async (uploadId, userId) => {
