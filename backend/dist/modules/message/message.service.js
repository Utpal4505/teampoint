...
const assertProjectPermission = async (tx, projectId, userId, permission) => {
...
const getDiscussionOrThrow = async (tx, projectId, discussionId) => {
...
const assertDecisionPermission = async (tx, projectId, discussionCreatorId, userId) => {
...
export const deleteMessageService = async (projectId, discussionId, messageId, userId) => {
    return prisma.$transaction(async (tx) => {
...
export const updateMessageService = async (projectId, discussionId, messageId, content, userId) => {
    return prisma.$transaction(async (tx) => {
        await assertProjectMember(projectId, userId, tx);
        await getDiscussionOrThrow(tx, projectId, discussionId);
        const message = await tx.message.findFirst({
