...
export const env = {
    ...
    GOOGLE_INTEGRATION_CLIENT_ID: requiredEnv('GOOGLE_INTEGRATION_CLIENT_ID'),
    GOOGLE_INTEGRATION_CLIENT_SECRET: requiredEnv('GOOGLE_INTEGRATION_CLIENT_SECRET'),
    ...
    GLOBAL_RATE_LIMIT: optionalEnv('GLOBAL_RATE_LIMIT', 100),
    AUTH_RATE_LIMIT: optionalEnv('AUTH_RATE_LIMIT', 5),
    UPLOAD_RATE_LIMIT: optionalEnv('UPLOAD_RATE_LIMIT', 30),
    API_RATE_LIMIT: optionalEnv('API_RATE_LIMIT', 60),
    INTEGRATION_RATE_LIMIT: optionalEnv('INTEGRATION_RATE_LIMIT', 20),
    REFRESH_TOKEN_RATE_LIMIT: optionalEnv('REFRESH_TOKEN_RATE_LIMIT', 10),
