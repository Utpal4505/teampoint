    ...
    <>
      <div className="flex flex-col h-full">
        ...
        <div className="p-6 flex flex-col gap-6 overflow-y-auto flex-1">
          {/* Stats strip with schedule button */}
          <div className="flex items-center justify-between gap-5 text-[12px] text-muted-foreground/50 border-b border-border/30 pb-4">
            {/* Stats on left */}
